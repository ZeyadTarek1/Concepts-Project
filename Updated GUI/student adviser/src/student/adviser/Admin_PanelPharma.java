 ...
 * @author spide
 */
public class Admin_PanelPharma extends javax.swing.JFrame {

    /**
     * Creates new form Admin_Panel
     */
    public Admin_PanelPharma() {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
           ...
           file = new File("Courses_Available_Pharma.txt");
           out = new FileWriter(file);
           jTextArea1.write(out);

        } catch (IOException ex) {
            Logger.getLogger(Admin_PanelPharma.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_PanelPharma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_PanelPharma().setVisible(true);
            }
        });
    }
