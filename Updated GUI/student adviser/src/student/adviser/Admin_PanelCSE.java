 ...
 * @author spide
 */
public class Admin_PanelCSE extends javax.swing.JFrame {

    /**
     * Creates new form Admin_Panel
     */
    public Admin_PanelCSE() {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
           ...
           file = new File("Courses_Available_CSE.txt");
           out = new FileWriter(file);
           jTextArea1.write(out);

        } catch (IOException ex) {
            Logger.getLogger(Admin_PanelCSE.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        jTextArea1.setText("");
        File file = new File("Courses_Available_CSE.txt");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_PanelCSE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_PanelCSE().setVisible(true);
            }
        });
    }
